"""Generic subset/complement DDMin. Gates are acceptance layers, not search hints."""
...
if EXP.name != "ddmin-real-004":
    raise RuntimeError(f"refusing to run outside ddmin-real-004: {EXP}")
